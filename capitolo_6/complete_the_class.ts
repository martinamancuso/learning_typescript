...
class Currency {
  ...
  // Hint: Look at the type of values being passed when `new Currency()` is called below.
  ...
  // Store the `code` and `symbol` parameter values in their corresponding class fields.
